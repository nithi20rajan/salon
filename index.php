							...
							<div class="form-group">
								<table>
									<tr>
										...
										<td>&nbsp;&nbsp;</td>
										<td>										
											<select id="area" name="area" class="form-control"onChange="getService(this.value);" >
												<option selected value="0">Select Area</option>
<?php	
$records = $salon_db->getDropdownVal("area");	
//getAreas();
foreach( $records['msg'] as $record ){		   
	echo "<option value='".$record['neighborhoods_id']."'>".$record['neighborhoods_name']."</option>"; 
}
